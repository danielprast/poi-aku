...
extension PoiModule.Data.Response {
  ...
  public struct PoiDetail: Codable {
    ...
    public struct PhotosSample: Codable {
      ...
      public init(photoID: String, photoURL: String, photoURLLarge: String?, videoThumbnailURL: String?, latitude: Double, longitude: Double, type: String, photoDatetimeUTC: String, photoTimestamp: Int) {
